  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uOpacity: { value: 1.0 },
        uCableColor: { value: new Float32Array([0.145, 0.388, 0.921]) },
        uPulseColor: { value: new Float32Array([0.376, 0.647, 0.980]) },
        uTunnelColor: { value: new Float32Array([0.113, 0.305, 0.847]) },
        uTunnelOpacity: { value: 0.05 },
        uGrain: { value: 1.0 },
