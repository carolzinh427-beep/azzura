  ...
  const rightControls = (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        className="px-3.5 py-1.5 bg-[#2563EB] hover:bg-[#1D4ED8] text-white rounded-full font-mono text-[10px] sm:text-xs font-bold tracking-wider uppercase transition-all duration-300 flex items-center gap-1 shadow-lg shadow-[#2563EB]/25"
      >
