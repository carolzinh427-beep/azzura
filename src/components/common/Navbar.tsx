...
export const Navbar: React.FC<NavbarProps> = ({ onOpenTickets }) => {
  ...
  const rightControls = (
    <div className="flex items-center gap-1.5 sm:gap-2">
      {/* Language Switcher */}
      <div className="flex items-center bg-black/80 border border-white/15 p-0.5 rounded-full text-[9px] sm:text-[10px] font-mono">
        <button
      ...
      <button
        ...
        className="px-2.5 sm:px-4 py-1.5 sm:py-2 bg-[#9333EA] hover:bg-[#7E22CE] text-white rounded-full font-mono text-[9px] sm:text-xs font-bold tracking-wider uppercase transition-all duration-300 flex items-center gap-1 sm:gap-1.5 shadow-lg shadow-[#9333EA]/35 whitespace-nowrap"
      >
