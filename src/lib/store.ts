...
export const INITIAL_EVENTS: EventItem[] = [
  {
    ...
    ticketTiers: [
      ...
      {
        id: 'tier-backstage',
        name: 'BACKSTAGE & BACKROOM VIP PASS',
        price: 75.00,
        currency: 'GBP',
        description: 'Exclusive access to artist lounge, private mezzanine bar, dedicated cloakroom, and express entry.',
        status: 'FEW_LEFT',
        entryTime: 'Valid all day',
        perks: ['Express VIP Fast Track', 'Artist Lounge Access', 'Private Cocktail Bar & Restrooms', 'Complimentary Cloakroom'],
      },
      {
        id: 'tier-table',
        name: 'PRIVATE SKYLINE TABLE (UP TO 8 GUESTS)',
        price: 850.00,
        currency: 'GBP',
        description: 'Premium elevated VIP booth with direct view of DJ booth & skyline, dedicated host, and £600 bar credit.',
        status: 'FEW_LEFT',
        entryTime: 'Valid all day',
        perks: ['8 VIP Wristbands', '£600 Minimum Beverage Credit', 'Dedicated Host & Security', 'Prime Sunset Panorama View'],
      }
    ]
  },
  {
